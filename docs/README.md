...
### 基础篇
- [RAG 基础概念](./07_RAG基础概念.md) — 什么是 RAG、完整流程、核心组件
- [Embedding 与向量化](./08_Embedding与向量化.md) — 文本转向量、双塔架构、相似度计算
- [文档切块](./09_文档切块.md) — 切块策略、块大小、重叠的重要性
- [向量数据库](./10_向量数据库.md) — Chroma、HNSW 索引、ANN 搜索
- [微调 vs RAG](./11_微调vsRAG.md) — 两种方案的区别、适用场景、LoRA

### 进阶篇
- [多路检索](./01_多路检索.md) — Query 改写、多 query 检索、合并去重
- [HyDE 检索](./02_HyDE检索.md) — 用"假答案"提升检索精度
- [上下文压缩](./03_上下文压缩.md) — 分数过滤 + LLM 精选
- [RAG 评估](./04_RAG评估.md) — 检索相关性、答案忠实度、相关性、完整性
- [对话记忆](./05_对话记忆.md) — 滑动窗口、摘要压缩、实体追踪、指代消解
- [混合检索](./06_混合检索.md) — BM25 + 向量、取并集、加权排序
